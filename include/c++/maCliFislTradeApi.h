...
public:
  ...
  // 组合委托响应
  virtual int OnRspCombOrder(CFirstSetField *p_pFirstSetField, CRspFislCombOrderField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }

  // 买卖委托响应(极速)
  virtual int OnRspOrderFlash(CFirstSetField *p_pFirstSetField, CRspFislOrderFlashField *p_pRspField, LONGLONG  p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }

  // 委托撤单响应(极速)
  virtual int OnRspCancelOrderFlash(CFirstSetField *p_pFirstSetField, CRspFislCancelOrderFlashField *p_pRspField, LONGLONG  p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }

  // 组合委托响应(极速)
  virtual int OnRspCombOrderFlash(CFirstSetField *p_pFirstSetField, CRspFislCombOrderFlashField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
  ...
  // 可用资金查询响应(次席调用)
  virtual int OnRspQryExpendableFundCiXi(CFirstSetField *p_pFirstSetField, CRspFislQryExpendableFundCiXiField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) {return 0;}
  ...
  // 确认回报
  virtual int OnRtnOrderConfirm(CRtnFislOrderConfirmField *p_pRtnField) {return 0;}

  // 成交回报
  virtual int OnRtnOrderFill(CRtnFislOrderFillField *p_pRtnField) {return 0;}

  // 申赎成交推送
  virtual int OnRtnOrderFill(CRtnFislPefEtfFillField *p_pRtnField) {return 0;}

  // 确认回报(极速)
  virtual int OnRtnOrderConfirmFlash(CRtnFislOrderConfirmFlashField *p_pRtnField) { return 0; }

  // 成交回报(极速)
  virtual int OnRtnOrderFillFlash(CRtnFislOrderFillFlashField *p_pRtnField) { return 0; }
  ...
  // 资金划拨(单账户多节点) 订单节点之间划拨响应[次席调用]
  virtual int OnRspFundTransferNodeCiXi(CFirstSetField *p_pFirstSetField, CRspFislFundTransferNodeCiXiField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) {return 0;}
  // 融资融券资金和信用额度查询响应
  ...
  // 大宗交易行情信息查询响应
  virtual int OnRspQryBlockTradingMktInfo(CFirstSetField *p_pFirstSetField, CRspFislQryBlockTradingMktInfoField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) {return 0;}
  // 盘后大宗行情信息查询响应
  virtual int OnRspQryClosingBlockTradingMktInfo(CFirstSetField *p_pFirstSetField, CRspFislQryClosingBlockTradingMktInfoField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) {return 0;}
  // 创业板盘后定价行情查询响应
  virtual int OnRspQryClosingMktSecondboard(CFirstSetField *p_pFirstSetField, CRspFislQryClosingMktSecondboardField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) {return 0;}
  // 模拟客户登录响应
  virtual int OnRspUserLoginImpersonate(CFirstSetField *p_pFirstSetField, CRspFislUserLoginImpersonateField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
  // 上海减持股份额度查询响应
  virtual int OnRspQryReductLimitSh(CFirstSetField *p_pFirstSetField, CRspFislQryReductLimitShField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
  // 深圳减持股份额度查询响应
  virtual int OnRspQryReductLimitSz(CFirstSetField *p_pFirstSetField, CRspFislQryReductLimitSzField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
  // 资金变动汇总查询响应
  virtual int OnRspQryFundEffectSummary(CFirstSetField *p_pFirstSetField, CRspFislQryFundEffectSummaryField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
  // 股份变动汇总查询响应
  virtual int OnRspQryStockEffectSummary(CFirstSetField *p_pFirstSetField, CRspFislQryStockEffectSummaryField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
  // 融券合约汇总查询响应
  virtual int OnRspQryFislContractExt(CFirstSetField *p_pFirstSetField, CRspFislContractExtField *p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) {return 0;}
  // 高频交易限制参数查询响应
  virtual int OnRspQryFreqTradeLmtParam(CFirstSetField* p_pFirstSetField, CRspFislQryFreqTradeLmtParamField* p_pRspField, LONGLONG p_llRequestId, int p_iFieldNum, int p_iFieldIndex) { return 0; }
};
...
public:
  ...
  // 买卖委托请求(极速)
  virtual int ReqOrderFlash(CReqFislOrderFlashField *p_pReqField, LONGLONG p_llRequestId);

  // 委托撤单请求(极速)
  virtual int ReqCancelOrderFlash(CReqFislCancelOrderFlashField *p_pReqField, LONGLONG p_llRequestId);
  ...
  // 可用资金查询请求(次席调用)
  virtual int ReqQryExpendableFundCiXi(CReqFislQryExpendableFundCiXiField *p_pReqField, LONGLONG p_llRequestId);
  ...
  // 合约展期申请查询
  virtual int ReqQryFislContractExt(CReqFislContractExtField *p_pReqField, LONGLONG p_llRequestId);
  ...
  // 资金变动汇总查询请求
  virtual int ReqQryFundEffectSummary(CReqFislQryFundEffectSummaryField *p_ReqField, LONGLONG p_llRequestId);
  // 股份变动汇总查询请求
  virtual int ReqQryStockEffectSummary(CReqFislQryStockEffectSummaryField *p_ReqField, LONGLONG p_llRequestId);
  // 资金帐户查询请求
  ...
  // 资金划拨(单账户多节点) 订单节点之间划拨请求[次席调用]
  virtual int ReqFundTransferNodeCiXi(CReqFislFundTransferNodeCiXiField *p_pReqField, LONGLONG p_llRequestId);
  // 融资融券资金和信用额度查询请求
  ...
  // 大宗交易行情信息查询请求
  virtual int ReqQryBlockTradingMktInfo(CReqFislQryBlockTradingMktInfoField *p_pReqField, LONGLONG p_llRequestId);
  // 盘后大宗行情信息查询请求
  virtual int ReqQryClosingBlockTradingMktInfo(CReqFislQryClosingBlockTradingMktInfoField *p_pReqField, LONGLONG p_llRequestId);
  // 创业板盘后定价行情查询请求
  virtual int ReqQryClosingMktSecondboard(CReqFislQryClosingMktSecondboardField *p_pReqField, LONGLONG p_llRequestId);
  // 组合委托请求
  virtual int ReqCombOrder(CReqFislCombOrderField *p_pReqField, LONGLONG p_llRequestId);
  // 组合委托请求(极速)
  virtual int ReqCombOrderFlash(CReqFislCombOrderFlashField *p_pReqField, LONGLONG p_llRequestId);
  // 模拟客户登录请求
  virtual int ReqUserLoginImpersonate(CReqFislUserLoginImpersonateField *p_pReqField, LONGLONG p_llRequestId);
  // 上海减持股份额度查询请求
  virtual int ReqQryReductLimitSh(CReqFislQryReductLimitShField *p_pReqField, LONGLONG p_llRequestId);
  // 深圳减持股份额度查询请求
  virtual int ReqQryReductLimitSz(CReqFislQryReductLimitSzField *p_pReqField, LONGLONG p_llRequestId);
  // 高频交易限制参数查询请求
  virtual int ReqQryFreqTradeLmtParam(CReqFislQryFreqTradeLmtParamField* p_pReqField, LONGLONG p_llRequestId);
public:
  // 异步回调函数
...
private:
  ...
  // 融券合约汇总查询响应
  void OnRspQryFislContractExt(CFirstSetField *p_pFirstSetField, LONGLONG p_llRequestId, int p_iFieldNum);
