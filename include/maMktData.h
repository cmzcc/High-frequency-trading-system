...
// 2023-05-10    1.8          何万刚          增加美股(含纽交所/纳斯达克)的支持：价格相关字段数据类型由unsigned int改为long long，修复美股几十万的股价乘以10000后就超过int32最大值问题(伯克希尔股价)
// 2023-07-05    1.9          高宇健          增加ST_MKT_DATA_MM-股转行情做市行情结构
//----------------------------------------------------------------------------
...
struct MACLIAPI ST_MKT_DATA
{
  ...
  LONGLONG        uiPreClosePrice;            // 昨收盘价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiOpenPrice;                // 开盘价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiHighPrice;                // 最高价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiLowPrice;                 // 最低价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiCurPrice;                 // 最新价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiAnsPrice[10];             // 申卖价【注意：数据类型已修改,变量名未变】
  LONGLONG        llAnsVol[10];               // 申卖量
  LONGLONG        uiBidPrice[10];             // 申买价【注意：数据类型已修改,变量名未变】
  ...
  LONGLONG        uiBidPriceAvg;              // 平均委买价格【注意：数据类型已修改,变量名未变】
  LONGLONG        uiAnsPriceAvg;              // 平均委卖价格【注意：数据类型已修改,变量名未变】
  int             iIopv;                      // IOPV
  int             iYield;                     // 到期收益率
  LONGLONG        uiHighLmtPrice;             // 涨停价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiLowLmtPrice;              // 跌停价【注意：数据类型已修改,变量名未变】
  char            szStkPrefix[16 + 1];        // 证券前缀
  LONGLONG        llPreOpenVol;               // 昨持仓量
  LONGLONG        uiSettPrice;                // 今结算价【注意：数据类型已修改,变量名未变】
  int             iPreDelta;                  // 昨虚实度
  int             iCurrDelta;                 // 今虚实度
  int             iNsyl1;                     // 市盈率1
  int             iNsyl2;                     // 市盈率2
  ...
  LONGLONG        uiPreSettPrice;             // 昨结算价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiClosePrice;               // 今收盘价【注意：数据类型已修改,变量名未变】
  ...
  LONGLONG        uiAuctionPrice;             // 上海动态参考价格，深圳熔断价格（期权）【注意：数据类型已修改,变量名未变】
...
struct MACLIAPI ST_MKT_DATA2
{
  ...
  LONGLONG        uiCurPrice;                 // 最新价（价格*10000)【注意：数据类型已修改,变量名未变】
  LONGLONG        uiAnsPrice[10];             // 申卖价（价格*10000)【注意：数据类型已修改,变量名未变】
  LONGLONG        llAnsVol[10];               // 申卖量
  LONGLONG        uiBidPrice[10];             // 申买价（价格*10000)【注意：数据类型已修改,变量名未变】
  LONGLONG        llBidVol[10];               // 申买量
  unsigned int    uiMatchedCnt;               // 成交笔数
  ...
  LONGLONG        uiPreClosePrice;            // 昨收盘价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiReserved1;                // 最高价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiReserved2;                // 最低价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiReserved3;                // 涨停价【注意：数据类型已修改,变量名未变】
  LONGLONG        uiReserved4;                // 跌停价【注意：数据类型已修改,变量名未变】
...
struct MACLIAPI ST_MKT_DATA3
{
  ...
  LONGLONG        uiCurPrice;                 // 最新价（价格*10000)【注意：数据类型已修改,变量名未变】
  LONGLONG        uiAnsPrice[5];              // 申卖价（价格*10000)【注意：数据类型已修改,变量名未变】
  LONGLONG        llAnsVol[5];                // 申卖量
  unsigned int    uiBidPrice[5];              // 申买价（价格*10000)【注意：数据类型已修改,变量名未变】
...
//股转行情做市行情结构
struct MACLIAPI ST_MKT_DATA_MM
{
  char            chMktType;              // 行情类型 固定 'a'
  long long       llMktDataTime;          // 接收时间
  char            chExchange;             // 交易所
  char            szTrdCode[16 + 1];      // 品种代码
  int             iTrdDate;               // 行情日期
  int             iDataTime;              // 行情时间
  ...
  LONGLONG        uiBidPrice[10];         // 申买价【注意：数据类型已修改,变量名未变】
  LONGLONG        llBidVol[10];           // 申买量
  LONGLONG        uiSSAnsPrice[10];       // 投资者申卖价【注意：数据类型已修改,变量名未变】
  LONGLONG        llSSAnsVol[10];         // 投资者申卖量
  LONGLONG        uiSSBidPrice[10];       // 投资者申买价【注意：数据类型已修改,变量名未变】
  LONGLONG        llSSBidVol[10];         // 投资者申买量
  unsigned int    uiMatchedCnt;           // 成交笔数
  LONGLONG        llMatchedVol;           // 成交量
  LONGLONG        llMatchedValue;         // 成交金额
...
struct MACLIAPI ST_MKT_MATCH
{
  ...
  LONGLONG       uiPrice;                // 成交价【注意：数据类型已修改,变量名未变】
  int            iOpenVol;               // 持仓增量
  unsigned int   uiMatchedCnt;           // 成交笔数
...
struct MACLIAPI ST_MKT_ORDER
{
  ...
  int            iDataTime;              // 委托时间
  int            iOrderNo;               // 委托号
  LONGLONG       uiOrderPrice;           // 委托价格【注意：数据类型已修改,变量名未变】
  int            iOrderVol;              // 委托数量
...
struct MACLIAPI ST_MKT_INDEX
{
  ...
  LONGLONG            llValues[INDEXLINE_NUM];    // 指标线的值
  char                szExtra[20*INDEXLINE_NUM+1];// 可能用的额外字符串
  LONGLONG            llExtra[5*INDEXLINE_NUM];   // 可能的额外数据
  int Serialize(char *p_szFmtMktDataStr, int p_iFmtMktDataStrLen);
  int DeSerialize(char * p_szFmtMktDataStr);
};
...
struct MACLIAPI ST_MKT_ORDER_QUEUE
{
  ...
  int            iDataTime;              // 委托时间
  int            iSide;                  // 买卖方向
  LONGLONG       iPrice;                 // 委托价格【注意：数据类型已修改,变量名未变】
...
{
  LONGLONG     uiPrice;     // 价【注意：数据类型已修改,变量名未变】
  int          iVol;        // 量
  int          iQueueSize;  // 队列长度
